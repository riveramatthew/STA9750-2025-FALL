...
<image-card alt="Urban skyline at dusk" src="https://github.com/riveramatthew/STA9750-2025-FALL/blob/main/young_prof.jpeg" ></image-card>
...
housing costs influence talent geography—NYC's persistently high rent
...
::: {.callout}
Visuals aren't afterthoughts—they're the storytellers. Here, we plot
...
rise, so do rents—often faster, per the slope \>1. Annotated outliers
...
as aging populations and pandemics boosted demand—tying into
...
decline—suggesting persistent family structures despite urban squeezes.
...
rent move in lockstep—often with rent outpacing income growth.
...
post-COVID rebound. This gradual thaw hints at policy wins—but sustained
...
highs? Absolutely—restrictive zoning starves supply, perpetuating
cycles.
...
voraciously for retirees/tourists. This metric rewards action—vital for
stock expansion, regardless of growth phase.

<image-card alt="Urban skyline at dusk" src="https://github.com/riveramatthew/STA9750-2025-FALL/blob/main/modern_apart.jpeg" ></image-card>
...
demand—preventing shortages in booms.
...
prioritizes bold building while rewarding responsiveness— a YIMBY
blueprint.
...
Cities can score high on one but not both—Myrtle Beach builds
...
Hinesville, GA slashed burden 9.3 pts (72.4 → 63.1) via military-driven
builds. Athens, GA grew 7.1% while easing 6.4 pts. Formula: Overbuild
supply → stabilize rents → welcome growth. These aren't flukes; they're
blueprints.
...
steep drop vs. Miami's stall? Pure policy divergence—building pays off.
...
qualifying metros aren't random—they cluster in the Sunbelt, military
...
element: how these dynamics appeal to millennials—the demographic
...
<image-card alt="Urban skyline at dusk" src="https://github.com/riveramatthew/STA9750-2025-FALL/blob/main/young_couple.jpeg" ></image-card>
...
Both metropolitan areas rely heavily on workers in this sector earning between $50,000-$70,000 annually—precisely the income range most squeezed by rising rents. In `r sponsor_yimby`, these workers face more manageable housing costs; in `r sponsor_nimby`, comparable workers face significantly higher rent burdens. **Our bill reduces this gap**, allowing employers to recruit and retain talent without constant wage pressure.
