...
To move beyond simple association and estimate a more defensible "desert effect," we employ a **difference-in-differences (DID) strategy**: comparing how vulnerability differs between desert and non-desert tracts *within the same borough*. This helps isolate the desert effect from borough-level confounders (e.g., Staten Island's isolation, Manhattan's density drive both access and vulnerability).
